        ...
        <div className="z-50 relative p-4 w-full max-w-md max-h-full">
          ...
          <div className="relative bg-white rounded-lg shadow-xl dark:bg-gray-700">
            ...
            <form onSubmit={handleSubmit} className="p-4 md:p-5">
              ...
              <button
                type="submit"
                className="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-sm text-sm px-2 py-2 mt-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 w-full"
              >
                Add new recipient
              </button>
            </form>
